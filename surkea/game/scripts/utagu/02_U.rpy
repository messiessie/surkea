label S_02_U:
    ...
    "In a minute I'm at the library door. Only Utagu's sitting on the floor outside it."
    ...
    show utagu uuh 
    utagu "Hey, Kura."
    kura "What are you doing out here?"

    show utagu huh 
    utagu "Oh, there's nobody in the library and I didn't like the feeling of being alone in there. This is better."
    kura "Really?"
    "I push open the library door to peek inside for a moment."
    "Sure enough, it's completely deserted. There's not even anyone at the front desk."
    kura "Huh. That's strange."
    utagu "It is."
    ...
    utagu "Try one of these, maybe."
    utagu "I just grabbed them, they're all on my reading list and I thought I'd take a look."
    show kura hmm
    kura "Oh, okay, sure."
    "I slide down to the ground beside her and pull the stack toward me, reading the spines."
    ...
    utagu "Thanks."
    utagu "I grew up on a lot of second-hand classic sci-fi and fantasy my parents gave me, so it sort of just happened."

    show utagu huh 
    utagu "It's weird, though."
    show kura hmm 
    kura "Hm?"
    ...
    show utagu uuh 
    utagu "I'm excited to get to it, actually."
    utagu "The author's written a lot of great robot and android stories. It's like, her specialty."

    show utagu huh 
    utagu "She has so many books, though, it's hard to find them all."
    utagu "That's one I've been looking for for a while now, I was happy to find it."

    show utagu smile 
    utagu "You'd probably like it, too. It's got the right blend of thriller and fun."
    show kura hmm 
    kura "Oh? That sounds like a good read."
    utagu "It definitely will be. Give it a look."
    kura "For sure. But what about this-"
    show kura hmm
    "I pause, confused."
    ...
    show kura hmm 
    kura "Nothing. I thought I took one of these other books, but I must be misremembering, because it's still there."
    ...
    show utagu worry 
    utagu "I wonder how that could happen…"
    ...
    show utagu uuh 
    utagu "Alright, Kura. If you say so…"
    kura "Yeah."
    ...
    show utagu smile 
    utagu "So I need to prioritize."
    show utagu uuh 
    utagu "I do think I'll take this one, though."
    show kura frown
    kura "You might need to wait a bit."

    show utagu huh 
    utagu "What do you mean?"
    show kura hmm
    kura "Well, there's nobody in there, right? How can we check out a book without a librarian?"

    show utagu frown 
    utagu "Right… I didn't see anybody when I came in, either. That's annoying."
