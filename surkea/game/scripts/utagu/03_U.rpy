label S_03_U:
    ...
    oni "Right."
    show kokoro smile_open 
    kokoro "But I decided I could just do both! So I put some chili in, gave it a stir, and put in a bit more."
    show kokoro grin2
    kokoro "And it came out just the way I wanted!"
    show kokoro grin
    kokoro "Of course, I still don't know which way is the right way, but it doesn't matter."
    show kokoro grin2
    kokoro "As long as it tastes good, who cares."
    
    show oni neutral
    oni "Of course. As long as it tastes good."
