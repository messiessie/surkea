label S_06_U:
    ...
    "Finally, Oni breaks the silence."
    show oni neutral:
    ...
    oni "The rest of the time, you're just going to be constantly worried for no reason. It's not worth it."
    ...
    "As I step closer, though, several things happen. They unfold slowly, yet happen all in the same instant."
    show utagu huh
    ...
    "Then, I feel myself falling, though into what I can't see."
    hide oni
    ...
    utagu "Look at this!"
    show utagu cry2
    utagu "This isn't me being upset like I usually am."

    show utagu despair
    utagu "I…{i}I feel like I'm gonna die{/i}"
    show kura frown

    kura "Utagu!"
    kura "Don't say that!"
    kura "You aren't going to die! Nothing's going to happen!"
    kura "For fuck's sake, we're just students!"
    kura "What ever happens to students? Nothing! We're just kids!"
    "But she isn't listening to me. Her eyes have glazed over and she's just mumbling, quietly."

    show utagu uuh

    utagu "So I was right all along..."
    utagu "Everyone told me not to worry, but I still did. Because I knew it."

    show utagu smile

    utagu "I always knew this was coming."
