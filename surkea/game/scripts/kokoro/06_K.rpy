label S_06_K:
    ...
    oni "See? It happened again. I swear, those technicians never fix those things."
    kura "What in the world are you referring to, Oni?"
    oni "You saw what just happened? That’s a new thing I heard the school wanted to try out. The windows can block out any source of light in a flash, so students aren’t so easily distracted by the outside."
    kura "Wow…"
    "Oni makes a face that says 'Right?' as she looks at me."
    kura "…That’s probably the dumbest shit I’ve ever heard as an excuse."
    ...
    kura "Kokoro, I know you aren’t alright. You aren’t handling things well. None of us are, but you shouldn’t freeze up and keep your anxiety to yourself."
    "She finally takes a deep breath."
    kura "We’re in this together. Let’s help each other out."
    kokoro "…"
    ...
    kokoro "Det… Tror jag inte?"
    "…I have no idea what words she just said."
    kokoro "I och för sig, den maten du lagade igår gav mig kramp… Men jag mår bättre nu!"
    ...
    utagu "No, no, no! Kokoro stop! We don’t understand what you’re saying!"
    kokoro “..?!"
    ...
    kura “So what’s the explanation for this then, Oni? Some dumb experiment the principle wants to pull on us?"
    “I get no answer. All I hear is Utagu’s crying."
    utagu “She’s gone! Where is she?! Where’s Kokoro?!"
    “Wait-“
