label S_03_K:
    ...
    kura "Kokoro?"
    kokoro "Hi hi!"
    kura "You're here early…"
    kokoro "Well, so are you!"
    "I groan as she sits beside me and sets down her things. She's right, and I regret it."
    kura "Believe me, I wouldn't be here this early if I could help it."
    kokoro "That's no way to talk! The early bird gets the worm, you know."
    kura "I don't even like worms."
    kokoro "Well, you should. They're very high in protein."
    kura "Ew…"
    kokoro "And anyway, it's just a metaphor!"
    kura "If it's just a metaphor, why does the protein content matter?"
    ...
    kura "Kokoro… your mug…"
    kokoro "My mug?"
    kokoro "Oh! Did you want some?"
    kura "No, I just… it's blue."
    kokoro "..."
    kokoro "Well, of course it is! It's a blue mug, silly."
    kura "But it was just pink."
    kokoro "Pink?"
    kokoro "Kura, I've never had a pink mug."
    kura "What are you talking about? You always have a pink mug you carry around, just like that one, except it's {i}pink{/i}."
    ...
    kokoro "You know that's not possible. Magic isn't real."
    kura "But I just saw it. Didn't you?"
    "She shrugs and starts to scribble in one of her notebooks."
    kokoro "I just see my mug. Blue like it always is."
    kokoro "You're probably still half-asleep."
    kokoro "Do you know about sleep paralysis?"
    ...
    kokoro "So you hallucinated the pink, and now you're not half-dreaming anymore so you see that it's blue."
    kura "Yeah, but…"
    kokoro "Don't worry. You'll be fully awake by the time class starts."
    kokoro "Which is good, because we'll need your help for our assignments!"
    kura "Yeah…"
return
