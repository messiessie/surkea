label S_02_K:
    ...
    #Hallway BG
    kokoro "I was hoping you'd help."
    ...
    kura "Now we just have to read through here and see if we find it."
    kokoro "That's a lot of reading..."
    kura "We don't have to read the whole thing. Maybe just look at the pictures and see if you recognise it."
    ...
    kura "That's a surprise."
    "She frowns at my mocking tone."
    kokoro "Hey, I have a life you know! So anyway, so there's this guy, and he works this awful desk job."
    kokoro "His boss is rude, his coworkers hate him, all the classic stuff."
    kura "Classic?"
    kokoro "You know what I mean. So he decides to quit his job and fulfill his dream of becoming an artist."
    kokoro "Then the whole show is about him trying to make it big as a painter or whatever."
    kura "Sounds pretty standard."
    kokoro "But then the twist is that the whole thing was in his imagination!"
    kokoro "Turns out he's just sat at his desk, daydreaming."
    kokoro "Crazy, right?!"
    "She studies my face for a reaction."
    kura "It would have been exciting if you hadn't just spoiled it for me."
