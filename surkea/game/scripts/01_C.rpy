label S_01_C:
    ...
    "Speaking of food…"
    kura smile "It's almost lunch, Oni. I promise I won't poison you this time."
    oni smile "Good thing I didn't miss this one, then."
    ...
    utagu worry "Oh, nothing. The homework we got is a bit much."
    ...
    kura frown "Maybe it's the weather? It looked like it was going to rain this morning."
    kokoro grin "Sorry girls, I checked the forecast and they said it'd be sunny all day. We should be fine, look!"
    "Kokoro smiles widely as she points to the window."
    utagu smile "I hope so. I didn't bring an umbrella today."
    "Utagu sighs again."
    ...
    kura hmm "What about you two?"
    "Utagu reacts and looks at me. Oni stares out the window, so I focus on Utagu."
    utagu worry "I uh… I was thinking about going to the library. I wanted to read more about some things for the homework we have."
    ...
    kura smile "You going home for the day, Oni?"
    "She looks at me."
...
label oniroute:
    ...
    if persistent.kokoroClear and persistent.utaguClear:
        ...
        scene TESTSCENE_ONI with Dissolve(1.5)
